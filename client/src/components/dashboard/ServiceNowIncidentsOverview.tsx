...
export const ServiceNowIncidentsOverview: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      servicenowService.getIncidentsAssignmentGroupTop10(selectedPlatform ?? undefined, days),
      servicenowService.getIncidentsPlatformApplicationTop10(selectedPlatform ?? undefined, days),
      servicenowService.getIncidentsPriorityDonut(selectedPlatform ?? undefined, days),
      servicenowService.getSlaPerformancePanel(selectedPlatform ?? undefined, days),
      servicenowService.getOpenIncidentAgeing(selectedPlatform ?? undefined, days),
      servicenowService.getTopIncidentCategories(selectedPlatform ?? undefined, days),
      servicenowService.getTopIncidentsByUpdateCount(selectedPlatform ?? undefined, days),
      servicenowService.getSlaBreachRiskAlertTickets(selectedPlatform ?? undefined, days),
