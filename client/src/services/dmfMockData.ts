...
export const MOCK_DMF_LINEAGE_JOBS = [
  { id:'lj1',  runId:'RUN-10001', processDate:'1/30/2026', sourceCode:'SPLUNK_LINE', datasetName:'SPLUNK_DIGITAL_OLB_MOBILE',     processTypeCode:'ING', sourceName:'SPLUNK_DIGITAL_OLB_MOBILE',       targetName:'SPLUNK_DIGITAL_OLB_MOBILE',           runStartTime:'1/30/2026 9:51 AM',  runEndTime:'1/30/2026 10:02 AM', status:'success' },
  { id:'lj2',  runId:'RUN-10002', processDate:'6/5/2026',  sourceCode:'DAILY',       datasetName:'TX_GOLD_DEP_RetailAcctsOpened', processTypeCode:'ENR', sourceName:'EDA_SILVER_DEP_DEP_ACCT_MASTER',  targetName:'PDM_MET_T_DEP_RETAIL_ACCTS_OPENED_F', runStartTime:'5/4/2026 9:03 AM',   runEndTime:'5/4/2026 10:28 AM',  status:'success' },
  { id:'lj3',  runId:'RUN-10003', processDate:'3/31/2026', sourceCode:'CPE_SCF',     datasetName:'CPE_SCF_DATA',                  processTypeCode:'ING', sourceName:'CPE_SCF_M',                       targetName:'PSS_COURSE_CATALOG',                  runStartTime:'3/8/2026 9:28 AM',   runEndTime:'3/8/2026 10:28 AM',  status:'success' },
  { id:'lj4',  runId:'RUN-10004', processDate:'3/21/2026', sourceCode:'PSS',         datasetName:'PSS_COURSE_CATALOG',            processTypeCode:'ING', sourceName:'PSS_COURSE_CATALOG',              targetName:'PSS_COURSE_CATALOG',                  runStartTime:'3/17/2026 10:02 AM', runEndTime:'3/17/2026 6:08 PM',  status:'success' },
  { id:'lj5',  runId:'RUN-10005', processDate:'3/18/2026', sourceCode:'FCMS',        datasetName:'FCMS_ALERT_DETAILS_FRAUD',      processTypeCode:'ING', sourceName:'FCMS_ALERT_DETAILS_FRAUD',        targetName:'FCMS_ALERT_DETAILS_FRAUD',            runStartTime:'3/17/2026 10:27 AM', runEndTime:'3/17/2026 6:14 PM',  status:'success' },
  { id:'lj6',  runId:'RUN-10006', processDate:'3/18/2026', sourceCode:'SASVIYA',     datasetName:'TEST_TRANSACTION_SAS_CRU_R',    processTypeCode:'ING', sourceName:'TEST_TRANSACTION_SAS_CRU_RESULT', targetName:'TEST_TRANSACTION_SAS_CRU_RESULT',     runStartTime:'3/17/2026 10:20 AM', runEndTime:'3/17/2026 5:32 PM',  status:'failed'  },
  { id:'lj7',  runId:'RUN-10007', processDate:'3/18/2026', sourceCode:'SASVIYA',     datasetName:'TEST_TRANSACTION_SAS_CRU_R',    processTypeCode:'ING', sourceName:'TEST_TRANSACTION_SAS_CRU_RESULT', targetName:'TEST_TRANSACTION_SAS_CRU_RESULT',     runStartTime:'3/16/2026 3:16 AM',  runEndTime:'3/17/2026 3:32 AM',  status:'success' },
  { id:'lj8',  runId:'RUN-10008', processDate:'3/18/2026', sourceCode:'GLD',         datasetName:'NCO_SF_LLC_BI_LOAN',            processTypeCode:'ENR', sourceName:'NCO_SF_LLC_BI_LOAN_SOURCE',       targetName:'NCO_SF_LLC_BI_LOAN_TARGET',           runStartTime:'3/16/2026 5:14 PM',  runEndTime:'3/16/2026 5:32 PM',  status:'success' },
  { id:'lj9',  runId:'RUN-10009', processDate:'3/17/2026', sourceCode:'SASVIYA',     datasetName:'TEST_TRANSACTION_SAS_CRU_R',    processTypeCode:'ING', sourceName:'TEST_TRANSACTION_SAS_CRU_RESULT', targetName:'TEST_TRANSACTION_SAS_CRU_RESULT',     runStartTime:'3/17/2026 3:33 AM',  runEndTime:'3/17/2026 6:39 AM',  status:'success' },
  { id:'lj10', runId:'RUN-10010', processDate:'3/17/2026', sourceCode:'DTA',         datasetName:'OLD_ONLINE_BANK_EXTRACT',       processTypeCode:'ING', sourceName:'OLD_ONLINE_BANK_EXTRACT',         targetName:'OLD_ONLINE_BANK_EXTRACT',             runStartTime:'3/17/2026 3:55 AM',  runEndTime:'3/17/2026 4:15 AM',  status:'success' },
  { id:'lj11', runId:'RUN-10011', processDate:'3/17/2026', sourceCode:'SASVIYA',     datasetName:'TEST_TRANSACTION_SAS_CRU_R',    processTypeCode:'ING', sourceName:'TEST_TRANSACTION_SAS_CRU_RESULT', targetName:'TEST_TRANSACTION_SAS_CRU_RESULT',     runStartTime:'3/17/2026 4:10 AM',  runEndTime:'3/17/2026 4:25 AM',  status:'failed'  },
  { id:'lj12', runId:'RUN-10012', processDate:'3/17/2026', sourceCode:'GLD',         datasetName:'NCO_SF_LLC_BI_LOAN',            processTypeCode:'ENR', sourceName:'NCO_SF_LLC_BI_LOAN_SOURCE',       targetName:'NCO_SF_LLC_BI_LOAN_TARGET',           runStartTime:'3/17/2026 3:28 AM',  runEndTime:'3/17/2026 3:31 AM',  status:'success' },
  { id:'lj13', runId:'RUN-10013', processDate:'3/17/2026', sourceCode:'SASVIYA',     datasetName:'TEST_TRANSACTION_SAS_CRU_R',    processTypeCode:'ING', sourceName:'TEST_TRANSACTION_SAS_CRU_RESULT', targetName:'TEST_TRANSACTION_SAS_CRU_RESULT',     runStartTime:'3/17/2026 4:03 AM',  runEndTime:'3/17/2026 6:04 AM',  status:'success' },
]
