...
export const MOCK_SN_INCIDENT_DETAIL = [
  // P1
  { sninc_inc_num: 'INC0089001', priority_field: 'P1', sninc_capability: 'BI Reporting',      sninc_short_desc: 'Critical ETL pipeline failure: BI reports stale for 6+ hours',      sninc_assignment_grp: 'DataOps Platform',  response_sla: '1 Hr',  resolution_sla: '4 Hrs', sninc_created_on: new Date(Date.now() - 5 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 1 * 3600000).toISOString(), elapsed_hours: 5, sla_breached: true },
  { sninc_inc_num: 'INC0089002', priority_field: 'P1', sninc_capability: 'Data Warehouse',    sninc_short_desc: 'Snowflake cluster unavailable — all downstream queries failing',     sninc_assignment_grp: 'Cloud Analytics',   response_sla: '1 Hr',  resolution_sla: '4 Hrs', sninc_created_on: new Date(Date.now() - 3 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 0.5 * 3600000).toISOString(), elapsed_hours: 3, sla_breached: false },
  { sninc_inc_num: 'INC0089003', priority_field: 'P1', sninc_capability: 'Data Integration',  sninc_short_desc: 'Full data ingestion pipeline down — DMF run status: FAILED',         sninc_assignment_grp: 'DataOps Platform',  response_sla: '1 Hr',  resolution_sla: '4 Hrs', sninc_created_on: new Date(Date.now() - 6 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 2 * 3600000).toISOString(), elapsed_hours: 6, sla_breached: true },
  // P2
  { sninc_inc_num: 'INC0089021', priority_field: 'P2', sninc_capability: 'ESP Scheduler',     sninc_short_desc: 'ESP batch window overrun by 2h — 12 jobs pending execution',         sninc_assignment_grp: 'DataOps Platform',  response_sla: '2 Hrs', resolution_sla: '8 Hrs', sninc_created_on: new Date(Date.now() - 9 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 3 * 3600000).toISOString(), elapsed_hours: 9, sla_breached: true },
  { sninc_inc_num: 'INC0089022', priority_field: 'P2', sninc_capability: 'BI Reporting',      sninc_short_desc: 'Dashboard refresh rate degraded — Snowflake query cache stale',      sninc_assignment_grp: 'Cloud Analytics',   response_sla: '2 Hrs', resolution_sla: '8 Hrs', sninc_created_on: new Date(Date.now() - 6 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 1 * 3600000).toISOString(), elapsed_hours: 6, sla_breached: false },
  { sninc_inc_num: 'INC0089023', priority_field: 'P2', sninc_capability: 'Data Integration',  sninc_short_desc: 'Talend remote engine disconnected — 4 jobs stuck in running state',  sninc_assignment_grp: 'DataOps Platform',  response_sla: '2 Hrs', resolution_sla: '8 Hrs', sninc_created_on: new Date(Date.now() - 7 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 2 * 3600000).toISOString(), elapsed_hours: 7, sla_breached: false },
  { sninc_inc_num: 'INC0089024', priority_field: 'P2', sninc_capability: 'Database Layer',    sninc_short_desc: 'PostgreSQL connection pool at 95% capacity during peak hours',       sninc_assignment_grp: 'Database Team',     response_sla: '2 Hrs', resolution_sla: '8 Hrs', sninc_created_on: new Date(Date.now() - 10 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 4 * 3600000).toISOString(), elapsed_hours: 10, sla_breached: true },
  { sninc_inc_num: 'INC0089025', priority_field: 'P2', sninc_capability: 'Monitoring',        sninc_short_desc: 'CloudWatch alert suppressed — missed batch latency spike overnight', sninc_assignment_grp: 'Platform Ops',      response_sla: '2 Hrs', resolution_sla: '8 Hrs', sninc_created_on: new Date(Date.now() - 4 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 0.5 * 3600000).toISOString(), elapsed_hours: 4, sla_breached: false },
  // P3
  { sninc_inc_num: 'INC0089101', priority_field: 'P3', sninc_capability: 'BI Reporting',      sninc_short_desc: 'DMF batch job step failure in nightly ingestion run',                sninc_assignment_grp: 'DataOps Platform',  response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 12 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 5 * 3600000).toISOString(), elapsed_hours: 12, sla_breached: false },
  { sninc_inc_num: 'INC0089102', priority_field: 'P3', sninc_capability: 'Data Integration',  sninc_short_desc: 'Talend job timeout on ESP scheduler queue — retry exhausted',        sninc_assignment_grp: 'DataOps Platform',  response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 30 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 10 * 3600000).toISOString(), elapsed_hours: 30, sla_breached: true },
  { sninc_inc_num: 'INC0089103', priority_field: 'P3', sninc_capability: 'ESP Scheduler',     sninc_short_desc: 'ESP scheduled jobs missed overnight window (3 jobs skipped)',        sninc_assignment_grp: 'DataOps Platform',  response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 18 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 8 * 3600000).toISOString(), elapsed_hours: 18, sla_breached: false },
  { sninc_inc_num: 'INC0089104', priority_field: 'P3', sninc_capability: 'BI Reporting',      sninc_short_desc: 'Snowflake query latency above SLA threshold for BI reports',         sninc_assignment_grp: 'Cloud Analytics',   response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 25 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 12 * 3600000).toISOString(), elapsed_hours: 25, sla_breached: true },
  { sninc_inc_num: 'INC0089105', priority_field: 'P3', sninc_capability: 'Data Integration',  sninc_short_desc: 'PostgreSQL connection pool exhausted during peak load',               sninc_assignment_grp: 'Database Team',     response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 8 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 2 * 3600000).toISOString(), elapsed_hours: 8, sla_breached: false },
  { sninc_inc_num: 'INC0089106', priority_field: 'P3', sninc_capability: 'DMF Orchestration', sninc_short_desc: 'DMF enrichment step failed for BIUK source dataset',                 sninc_assignment_grp: 'DataOps Platform',  response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 40 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 15 * 3600000).toISOString(), elapsed_hours: 40, sla_breached: true },
  { sninc_inc_num: 'INC0089107', priority_field: 'P3', sninc_capability: 'Monitoring',        sninc_short_desc: 'CloudWatch alarm misconfigured — batch latency not alerting',        sninc_assignment_grp: 'Platform Ops',      response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 6 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 1 * 3600000).toISOString(), elapsed_hours: 6, sla_breached: false },
  { sninc_inc_num: 'INC0089108', priority_field: 'P3', sninc_capability: 'BI Reporting',      sninc_short_desc: 'Report render timeout on Executive Dashboard for date range >90d',   sninc_assignment_grp: 'BI Dev Team',       response_sla: '4 Hrs', resolution_sla: '2 Days', sninc_created_on: new Date(Date.now() - 35 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 14 * 3600000).toISOString(), elapsed_hours: 35, sla_breached: true },
  // P4
  { sninc_inc_num: 'INC0089109', priority_field: 'P4', sninc_capability: 'Data Integration',  sninc_short_desc: 'Talend log table growing beyond expected partition size',              sninc_assignment_grp: 'DataOps Platform',  response_sla: '8 Hrs', resolution_sla: '5 Days', sninc_created_on: new Date(Date.now() - 48 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 20 * 3600000).toISOString(), elapsed_hours: 48, sla_breached: false },
  { sninc_inc_num: 'INC0089110', priority_field: 'P4', sninc_capability: 'ESP Scheduler',     sninc_short_desc: 'ESP calendar definition missing holiday exception for Q2',            sninc_assignment_grp: 'DataOps Platform',  response_sla: '8 Hrs', resolution_sla: '5 Days', sninc_created_on: new Date(Date.now() - 72 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 30 * 3600000).toISOString(), elapsed_hours: 72, sla_breached: false },
  { sninc_inc_num: 'INC0089111', priority_field: 'P4', sninc_capability: 'BI Reporting',      sninc_short_desc: 'Minor discrepancy in weekly KPI rollup figures (< 0.1%)',             sninc_assignment_grp: 'BI Dev Team',       response_sla: '8 Hrs', resolution_sla: '5 Days', sninc_created_on: new Date(Date.now() - 36 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 14 * 3600000).toISOString(), elapsed_hours: 36, sla_breached: false },
  { sninc_inc_num: 'INC0089112', priority_field: 'P4', sninc_capability: 'Monitoring',        sninc_short_desc: 'Grafana dashboard stale after Prometheus scrape interval change',     sninc_assignment_grp: 'Platform Ops',      response_sla: '8 Hrs', resolution_sla: '5 Days', sninc_created_on: new Date(Date.now() - 24 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 8 * 3600000).toISOString(), elapsed_hours: 24, sla_breached: false },
  { sninc_inc_num: 'INC0089113', priority_field: 'P4', sninc_capability: 'DMF Orchestration', sninc_short_desc: 'DMF lineage metadata not refreshed after schema change',              sninc_assignment_grp: 'DataOps Platform',  response_sla: '8 Hrs', resolution_sla: '5 Days', sninc_created_on: new Date(Date.now() - 60 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 22 * 3600000).toISOString(), elapsed_hours: 60, sla_breached: false },
  { sninc_inc_num: 'INC0089114', priority_field: 'P4', sninc_capability: 'Cloud Analytics',   sninc_short_desc: 'Snowflake credit usage 12% over forecast for the billing period',     sninc_assignment_grp: 'Cloud Analytics',   response_sla: '8 Hrs', resolution_sla: '5 Days', sninc_created_on: new Date(Date.now() - 84 * 3600000).toISOString(), sninc_last_updt_dttm: new Date(Date.now() - 36 * 3600000).toISOString(), elapsed_hours: 84, sla_breached: false },
]
